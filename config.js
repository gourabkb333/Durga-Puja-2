...
const SITE_CONFIG = {
  ...
  // --- Puja pandal routes ---
  // Each route shows a tappable list of your pandal stops. Tapping any
  // stop opens your full Google My Maps route (all pins) in a new tab —
  // Google doesn't allow pulling the pin list automatically into a page
  // like this without a paid Maps API key, so list the stop names here
  // once, in whatever order you like (ideally matching your map).
  //
  // mapUrl: from your My Maps "mid=" value, as:
  // https://www.google.com/maps/d/viewer?mid=YOUR_MAP_ID
  mapRoutes: {
    north: {
      mapUrl: "https://www.google.com/maps/d/viewer?mid=10LEbb7bMSSSToAIK_Th4Qtas8nVK9xI",
      stops: [
        "স্থান ১",
        "স্থান ২"
        // Add more like this:
    ...
    south: {
      mapUrl: "https://www.google.com/maps/d/viewer?mid=1WtvNwqGzLS7Bkhgr4ChJA5IRRiEDF-E",
      stops: [
        "স্থান ১",
        "স্থান ২"
        // "Ekdalia Evergreen",
